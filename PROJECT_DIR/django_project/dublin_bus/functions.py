...
def route_prediction_15A(stops, actualtime_arr_stop_first, day_of_week, month, weekday, bank_holiday,
    ...
    first_stop_list = [340.0, 350.0, 351.0, 352.0, 353.0, 395.0, 396.0, 397.0, 398.0, 399.0, 400.0, 407.0, 1016.0,
                       1017.0, 1018.0, 1019.0, 1020.0, 1069.0, 1070.0, 1071.0, 1072.0, 1076.0, 1077.0, 1078.0, 1079.0,
                       1080.0, 1081.0, 1082.0, 1083.0, 1085.0, 1086.0, 1087.0, 1088.0, 1089.0, 1090.0, 1091.0, 1092.0,
                       1093.0, 1094.0, 1095.0, 1096.0, 1101.0, 1102.0, 1103.0, 1105.0, 1107.0, 1108.0, 1109.0, 1110.0,
                       1111.0, 1112.0, 1113.0, 1114.0, 1115.0, 1117.0, 1118.0, 1119.0, 1120.0, 1164.0, 1165.0, 1166.0,
                       1167.0, 1168.0, 1169.0, 1170.0, 1283.0, 1285.0, 1353.0, 1354.0, 2437.0, 2498.0, 2499.0, 4528.0,
                       7216.0, 7558.0, 7577.0, 7578.0, 7579.0, 7581.0, 7582.0, 7589.0]
    second_stop_list = [340.0, 350.0, 351.0, 352.0, 353.0, 354.0, 396.0, 397.0, 398.0, 399.0, 400.0, 407.0, 1016.0,
                        1017.0, 1018.0, 1019.0, 1020.0, 1069.0, 1070.0, 1071.0, 1072.0, 1076.0, 1077.0, 1078.0, 1079.0,
                        1080.0, 1081.0, 1082.0, 1083.0, 1085.0, 1086.0, 1087.0, 1088.0, 1089.0, 1090.0, 1091.0, 1092.0,
                        1093.0, 1094.0, 1095.0, 1096.0, 1101.0, 1102.0, 1103.0, 1104.0, 1107.0, 1108.0, 1109.0, 1110.0,
                        1111.0, 1112.0, 1113.0, 1114.0, 1115.0, 1117.0, 1118.0, 1119.0, 1120.0, 1164.0, 1165.0, 1166.0,
                        1167.0, 1168.0, 1169.0, 1170.0, 1283.0, 1285.0, 1353.0, 1354.0, 2437.0, 2498.0, 2499.0, 4528.0,
                        7216.0, 7558.0, 7577.0, 7578.0, 7579.0, 7581.0, 7582.0, 7589.0]
    ...
    for i in range(len(stops) - 1):
        ...
        input = [
            [actualtime_arr_stop_first, rain, temp, rhum, msl, weekday, bank_holiday] + first_stop_ref[stop_first] + \
...
def predict_journey_time(stops, timestamp):
    ...
    prediction = route_prediction_15A(stops, actualtime_arr_stop_first, day_of_week, month, weekday, bank_holiday, rain,
                                      temp, rhum, msl)
