...
class TestTimestampToDayBus(unittest.TestCase):
    ...
    def test_same_day(self):
        """Test to check the value returned for a value less than 86400 seconds (24*60*60)."""
        self.assertEqual(convert_timestamp.timestamp_to_day_bus('2018-01-31 00:00:00', 37000, 1), 31) 
    ...
    def test_after_midnight_mid_month(self):
        ...
        self.assertEqual(convert_timestamp.timestamp_to_day_bus('2018-01-05 00:00:00', 86500, 1), 6) 
    ...
    def test_after_midnight_end_31(self):
        ...
        self.assertEqual(convert_timestamp.timestamp_to_day_bus('2018-01-31 00:00:00', 86400, 1), 1) 

    def test_after_midnight_end_30(self):
        """Test to check the value returned for a day at the end of a 31 day month when seconds are >= 86400."""
        self.assertEqual(convert_timestamp.timestamp_to_day_bus('2018-11-30 00:00:00', 86450, 11), 1)
    ...
    def test_after_midnight_end_feb(self):
        ...
        self.assertEqual(convert_timestamp.timestamp_to_day_bus('2018-02-28 00:00:00', 86450, 2), 1)
